frappe.ready(function() {
	...
	var customer_address = $('select[data-fieldname = "customer_address"]')[0];
	$('select[data-fieldname = "customer_address"]').change(function() {set_customer_address_display();});
...
function set_customer_address_display() {
	console.log($('select[data-fieldname = "customer_address"]')[0].value);
	if ($('select[data-fieldname = "customer_address"]')[0].value) {
		frappe.call({
			...
			args: {
				"address_name": $('select[data-fieldname = "customer_address"]')[0].value
			},
			callback: function(response) {
				if (response.message) {
